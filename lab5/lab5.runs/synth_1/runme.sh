...
HD_PWD='/nfs/home/k/k_gallar/COEN313/lab5/lab5/lab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log twos_complementor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source twos_complementor.tcl
