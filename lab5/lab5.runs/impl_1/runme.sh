...
HD_PWD='/nfs/home/k/k_gallar/COEN313/lab5/lab5/lab5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log twos_complementor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source twos_complementor.tcl -notrace
